...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = "default", ...props }, ref) => {
    const variants = {
      ...
      interactive: "bg-card text-card-foreground shadow-md border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer",
      glass: "bg-card/80 backdrop-blur-md text-card-foreground shadow-lg border border-border/50",
    };
